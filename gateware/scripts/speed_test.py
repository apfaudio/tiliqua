#!/usr/bin/env python3
#
# USB2 bulk speedtest slightly modified to work out of tree of LUNA.
# Designed to be run against TIliqua's 'selftest' bitstream, which
# includes/exposes a USBSpeedTestDevice.
#
