...
def plot_sunburst(df, resource_type, output_file):
    fig = px.sunburst(
        df,
        names='name',
        parents='parent',
...
def main():
    ...
    parser.add_argument('resource_type', nargs='?', default='LUT4', help='Resource type to plot (default: LUT4)')
    parser.add_argument('--output', '-o', default='usage_plot.html', help='Output HTML file (default: usage_plot.html)')
    ...
    #print(df)
    plot_sunburst(df, args.resource_type, args.output)
