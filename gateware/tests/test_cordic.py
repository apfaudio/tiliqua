...
class CordicTests(unittest.TestCase):
    ...
    def test_cordic_vector(self):
        ...
        dut = cordic.MagPhaseCordic(self.SHAPE, iterations=8)
        ...
        async def test_case(ctx, real, imag, name=""):
            ...
            # Assert reasonable accuracy (considering fixed-point limitations)
        ...
        async def testbench(ctx):
            ...
            print("\n=== CORDIC Vector Mode Test Results ===")
