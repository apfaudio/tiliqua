...
class _TiliquaR5Mobo:
    resources  = _TiliquaR4R5Mobo.resources + [
        ...
        Resource("dvi", 0,
            ...
            Attrs(IO_TYPE="LVPECL33E", SLEWRATE="FAST")
         ),
    ]
...
class TiliquaR2SC2Platform(SoldierCrabR2Platform, LUNAPlatform):
    ...
    version_major          = 2
    clock_domain_generator = pll.TiliquaDomainGenerator4PLLs
    default_audio_clock    = pll.AudioClock.FINE_48KHZ
...
class TiliquaR2SC3Platform(SoldierCrabR3Platform, LUNAPlatform):
    ...
    version_major          = 2
    clock_domain_generator = pll.TiliquaDomainGenerator2PLLs
    default_audio_clock    = pll.AudioClock.COARSE_48KHZ
    default_usb_connection = "ulpi"
...
class TiliquaR4SC3Platform(SoldierCrabR3Platform, LUNAPlatform):
    name                   = ("Tiliqua R4 / SoldierCrab R3 "
                              f"({SoldierCrabR3Platform.device}/{SoldierCrabR3Platform.psram_id})")
    version_major          = 4
    clock_domain_generator = pll.TiliquaDomainGeneratorPLLExternal
    default_audio_clock    = pll.AudioClock.FINE_48KHZ
    default_usb_connection = "ulpi"
