...
class TiliquaSoc(Component):
    ...
    def genconst(self, dst):
        ...
        with open(dst, "w") as f:
            ...
            f.write(f"pub const HW_REV_MAJOR: u32        = {self.platform_class.version_tuple[0]};\n")
            f.write(f"pub const HW_REV_MINOR: u32        = {self.platform_class.version_tuple[1]};\n")
            f.write(f"pub const HW_REV_PATCH: u32        = {self.platform_class.version_tuple[2]};\n")
