...
module VexiiRiscv (
  ...
  assign _zz_execute_ctrl1_down_SrcStageables_ZERO_lane0_2 = (|{_zz_execute_ctrl1_down_SrcStageables_ZERO_lane0,((execute_lane0_logic_decoding_decodingBits & 33'h000000024) == 33'h000000024)});
  ...
  assign _zz_execute_ctrl1_down_AguPlugin_CLEAN_lane0_1 = (|{((execute_lane0_logic_decoding_decodingBits & 33'h000202008) == 33'h000202008),((execute_lane0_logic_decoding_decodingBits & 33'h000102008) == 33'h000102008)});
  assign _zz_execute_ctrl1_down_AguPlugin_INVALIDATE_lane0 = _zz_execute_ctrl1_down_AguPlugin_INVALIDATE_lane0_1[0];
  assign _zz_execute_ctrl1_down_AguPlugin_INVALIDATE_lane0_1 = (|((execute_lane0_logic_decoding_decodingBits & 33'h000102008) == 33'h000002008));
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_lsu_ctrl_doCbm) begin
      LsuL1Plugin_logic_waysWrite_address = execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[9 : 6];
    end
    if(LsuL1Plugin_logic_lsu_ctrl_doFlush) begin
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_lsu_ctrl_doCbm) begin
      LsuL1Plugin_logic_waysWrite_tag_address = execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[31 : 10];
    end
    if(LsuL1Plugin_logic_lsu_ctrl_doFlush) begin
  ...
  always @(*) begin
    ...
    if(LsuL1Plugin_logic_lsu_ctrl_doCbm) begin
      LsuL1Plugin_logic_writeback_push_payload_address = ({6'd0,{execute_ctrl4_down_LsuL1_PHYSICAL_ADDRESS_lane0[31 : 10],execute_ctrl4_down_LsuL1_MIXED_ADDRESS_lane0[9 : 6]}} <<< 3'd6);
    end
    if(LsuL1Plugin_logic_lsu_ctrl_doFlush) begin
  ...
  assign _zz_execute_ctrl1_down_SrcStageables_ZERO_lane0 = ((execute_lane0_logic_decoding_decodingBits & 33'h000000008) == 33'h000000008);
  assign execute_ctrl1_down_SrcStageables_ZERO_lane0 = _zz_execute_ctrl1_down_SrcStageables_ZERO_lane0_1[0];
  assign execute_ctrl1_down_early0_SrcPlugin_logic_SRC1_CTRL_lane0 = (|((execute_lane0_logic_decoding_decodingBits & 33'h00000004c) == 33'h000000004));
  ...
  assign _zz_execute_ctrl1_down_BranchPlugin_BRANCH_CTRL_lane0_1 = {(|_zz_execute_ctrl1_down_lane0_integer_WriteBackPlugin_SEL_lane0),(|_zz_execute_ctrl1_down_SrcStageables_ZERO_lane0)};
