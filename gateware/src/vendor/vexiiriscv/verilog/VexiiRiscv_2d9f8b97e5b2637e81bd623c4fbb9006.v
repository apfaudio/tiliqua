...
module VexiiRiscv (
  ...
  assign _zz_LsuPlugin_logic_onPma_io_rsp_fault_3 = (LsuPlugin_pmaBuilder_io_addressBits & 32'hfffffffc);
  assign _zz_LsuPlugin_logic_onPma_io_rsp_fault_4 = 32'hb0000000;
